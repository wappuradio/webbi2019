...
const Info: FunctionComponent<InfoProps> = ({infoData, licenseData}) => (
  <section className='view-container'>
    ...
    <p><strong>ASSYRADIO</strong> lähettää ohjelmaa <strong>1.8.2019 klo 13 alkaen</strong> ympäri vuorokauden Assemblyjen loppuun asti. Kuuntele ständin vieressä taajuudella <strong>106,4 MHz</strong> tai netissä. Liity keskusteluun <a target="_blank" href="https://t.me/wappuradio"><strong>Telegram</strong></a>-ryhmässä, IRCnetissä kanavalla <strong>#wappuradio</strong> tai Assemblyjen Discordissa kanavalla <strong>#assyradio</strong>.</p>
    <p><strong>Rakkauden Wappuradio&trade;</strong> sen sijaan lähettää ohjelmaa taas <strong>15.4.2020&nbsp;klo&nbsp;14</strong> alkaen ympäri vuorokauden aina wappuaattoon asti.</p>
